...
function getTopIcons() {
  ...
  const topSlugs = new Set([
    ...
    'nodedotjs', 'express', 'nestjs', 'deno', 'bun', 'fastify', 'hono', 'koa', 'spring', 'springboot', 'django', 'flask', 'fastapi', 'laravel', 'rubyonrails', 'dotnet', 'aspnet',
    ...
    'docker', 'kubernetes', 'nginx', 'linux', 'ubuntu', 'debian', 'centos', 'redhat', 'fedora', 'alpine', 'windows', 'macos', 'android', 'apple', 'ios', 'chrome', 'googlechrome', 'firefox', 'safari', 'edge',
    ...
    'unity', 'unrealengine', 'godotengine', 'cocos', 'phaser', 'cryengine', 'steam', 'steamworks', 'epicgames', 'blender', 'maya', 'zbrush',
    ...
    'markdown', 'latex', 'svg', 'mermaid', 'hexo', 'hugo', 'jekyll', 'docusaurus', 'eleventy', 'vuepress', 'vitepress', 'notion', 'obsidian', 'confluence', 'wordpress', 'ghost', 'medium', 'strapi',
