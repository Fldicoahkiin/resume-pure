                      ...
                      >
                        <div className="flex flex-wrap sm:flex-nowrap items-center gap-2">
                          ...
                          <button
                            ...
                            className={`shrink-0 p-1.5 transition sm:opacity-0 group-hover:opacity-100 focus:opacity-100 ${openSettings[item.id] ? 'text-blue-500 sm:opacity-100' : 'text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'}`}
                            title="高级设置"
                          >
                            <Settings2 size={16} />
                          </button>
