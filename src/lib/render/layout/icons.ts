...
const CONTACT_SCHOOL_ICON = 'M21.42 10.92a1 1 0 000-1.84L12.83 5.18a2 2 0 00-1.66 0L2.6 9.08a1 1 0 000 1.83l8.58 3.91a2 2 0 001.66 0z M22 10v6 M6 12.5V16a6 3 0 0012 0v-3.5';
...
export function getContactIconVisual(type: string, iconSize: number): ContactVisual {
  ...
  if (normalized.includes('graduation') || normalized.includes('school')) {
    return {
      paths: [
        createPath(CONTACT_SCHOOL_ICON, 0, 0, iconSize, iconSize, undefined, MUTED_TEXT_COLOR, strokeWidth),
      ],
    };
  }
